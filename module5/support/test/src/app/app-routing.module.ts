...
import { ListOfMeComponent } from './components/product/list-of-me/list-of-me.component';
import {FormsModule, ReactiveFormsModule} from "@angular/forms";

const routes: Routes = [
  // {path: '', component: ListComponent},
  {path: '', component: ListOfMeComponent},

  // {path: 'list', component: ListComponent},
  {path: 'list', component: ListOfMeComponent},
...
@NgModule({
  ...
  declarations: [PageNotFoundComponent, ListComponent, CreateComponent, DeleteComponent, EditComponent,
    DetailComponent, ListOfMeComponent]
})

...
-- ------ Chuyến đi
insert into flight_information( airline, departure, arrival, departure_date, arrival_date, departure_time, arrival_time, flight_code, `type`, price)
-- Đà Nẵng
...
CREATE TABLE promotion (
    ...
    departure_day VARCHAR(40),
    departure_place VARCHAR(40),
    departure_time VARCHAR(40),
    arrival_place VARCHAR(40),
    arrival_time VARCHAR(40),
    information VARCHAR(45),
    price LONG
);

insert into promotion (airline, flight, flightNumber, departure_day, departure_place, arrival_place, departure_time, arrival_time, information, price)
values ('VietJet','DAD-SGN','VJ 176 Hạng Eco','01/01/2021','Đà Nẵng (DAD)','5:15AM','Tp.HCM (SGN)','7:25AM','Bonus 7 kg','99.000'),
	   ('VietJet','DAD-SGN','VJ 246 Hạng SkyBoss','03/01/2021','Đà Nẵng (DAD)','5:15AM','Tp.HCM (SGN)','7:25AM','Bonus 7 kg','899.000'),
	   ('VietJet','DAD-SGN','VJ 111 Hạng Deluxe','05/01/2021','Đà Nẵng (DAD)','5:15AM','Tp.HCM (SGN)','7:25AM','Bonus 7 kg','529.000'),
       ('VietJet','DAD-HAN','VJ 201 Hạng Deluxe','01/01/2021','Đà Nẵng (DAD)','5:15AM','Hà Nội (HAN)','7:25AM','Bonus 7 kg','599.000'),
       ('VietJet','HAN-PQC','VJ176 Hạng Eco','01/01/2021','Hà Nội (HAN)','8:15AM','Phú Quốc (PQC)','10:25AM','Bonus 7 kg','1.039.000'),
	   ('VietJet','HPH-SGN','VJ176 Hạng Eco','10/01/2021','Hải Phòng (HPH)','5:15AM','Tp.HCM (SGN)','7:25AM','Bonus 7 kg','2.790.000'),
	   ('VietJet','DAD-SGN','VJ176 Hạng SkyBoss','12/01/2021','Đà Nẵng (DAD)','5:15AM','Tp.HCM (SGN)','7:25AM','Bonus 7 kg','1.689.000'),
       ('VietJet','DAD-SGN','VJ176 Hạng Eco','16/01/2021','Đà Nẵng (DAD)','5:15AM','Tp.HCM (SGN)','7:25AM','Bonus 7 kg','99.000'),
       ('VietJet','DAD-SGN','VJ176 Hạng Eco','17/01/2021','Đà Nẵng (DAD)','5:15AM','Tp.HCM (SGN)','7:25AM','Bonus 7 kg','99.000'),
	   ('VietJet','DAD-SGN','VJ176 Hạng Eco','20/01/2021','Đà Nẵng (DAD)','5:15AM','Tp.HCM (SGN)','7:25AM','Bonus 7 kg','99.000'),
	   ('VietJet','DAD-SGN','VJ176 Hạng Eco','21/01/2021','Đà Nẵng (DAD)','5:15AM','Tp.HCM (SGN)','7:25AM','Bonus 7 kg','99.000'),
       ('VietJet','HPH-SGN','VJ176 Hạng Deluxe','23/01/2021','Hải Phòng (HPH)','5:15AM','Tp.HCM (SGN)','7:25AM','Bonus 7 kg','2.990.000'),
	   ('VietJet','HPH-SGN','VJ176 Hạng SkyBoss','25/01/2021','Hải Phòng (HPH)','9:15AM','Tp.HCM (SGN)','11:25AM','Bonus 7 kg','5.990.000');

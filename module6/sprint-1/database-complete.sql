...
# role
insert into project1_ticket_agency.app_role (id, name) values (1, 'Admin');
insert into project1_ticket_agency.app_role (id, name) values (2, 'Employee');
insert into project1_ticket_agency.app_role (id, name) values (3, 'User');
# account
insert into project1_ticket_agency.app_account (id, enabled, password, username, verification_code, app_role_id) values (1, true, '$2a$10$an/E3E9ow74oSYc6jJluyOGnxMSeXai7kAM0uKIhioAe.CpE/gtqy', 'user@gmail.com', 'o1vsAyF2yV4O4Xs6AY2QMwxgp62adEMs1qnuVQhIDEMqp45wLadHqfaQVtwsAIoX', 3);
insert into project1_ticket_agency.app_account (id, enabled, password, username, verification_code, app_role_id) values (2, true, '$2a$10$an/E3E9ow74oSYc6jJluyOGnxMSeXai7kAM0uKIhioAe.CpE/gtqy', 'admin@gmail.com', 'o1vsAyF2yV4O4Xs6AY2QMwxgp62adEMs1qnuVQhIDEMqp45wLadHqfaQVtwsAIoX', 1);
insert into project1_ticket_agency.app_account (id, enabled, password, username, verification_code, app_role_id) values (3, true, '$2a$10$an/E3E9ow74oSYc6jJluyOGnxMSeXai7kAM0uKIhioAe.CpE/gtqy', 'employee@gmail.com', 'o1vsAyF2yV4O4Xs6AY2QMwxgp62adEMs1qnuVQhIDEMqp45wLadHqfaQVtwsAIoX', 2);
# admin, user, employee
...
# luggage
INSERT INTO `luggage` VALUES (1,'Gói 15kg',155000),(2,'Gói 20kg',175000),(3,'Kiện HLQK 20kg',375000);
# flight info
INSERT INTO `flight_information` VALUES (1,'VietJet','TP Hồ Chí Minh (SGN)','2020-12-22','13:05:00','Đà Nẵng (DAD)','2020-12-22','11:40:00','VJ629',49000,'Hạng phổ thông'),
...
# ticket
INSERT INTO `project1_ticket_agency`.`ticket` (`passenger_name`, `price_departure`, `status_checkin`, `ticket_code`, `employee_id`, `flight_information_id`, `status_payment_id`) VALUES ('Nguyen Van An', 124124, 0, 'AB002', 1, 4, 2);
INSERT INTO `project1_ticket_agency`.`ticket` (`passenger_name`, `price_departure`, `status_checkin`, `ticket_code`, `employee_id`, `flight_information_id`, `status_payment_id`) VALUES ('Tran Van Be', 124124, 0, 'AB002', 1, 4, 2);
INSERT INTO `project1_ticket_agency`.`ticket` (`passenger_name`, `price_departure`, `status_checkin`, `ticket_code`, `employee_id`, `flight_information_id`, `status_payment_id`) VALUES ('Phan Thi Diem', 124124, 0, 'AB002', 1, 7, 2);
INSERT INTO `project1_ticket_agency`.`ticket` (`passenger_name`, `price_departure`, `status_checkin`, `ticket_code`, `employee_id`, `flight_information_id`, `status_payment_id`) VALUES ('Ly Tieu Dao', 124124, 0, 'AB002', 1, 7, 2);
INSERT INTO `project1_ticket_agency`.`ticket` (`passenger_name`, `price_departure`, `status_checkin`, `ticket_code`, `employee_id`, `flight_information_id`, `status_payment_id`) VALUES ('Ho Thi Se', 124124, 0, 'AB002', 1, 11, 2);
...
(26,'VietJet Air','Tp.HCM (SGN)','11:25:00','2021-01-06','Hải Phòng (HPH)','09:15:00','HPH-SGN','VJ 246','',5990000)